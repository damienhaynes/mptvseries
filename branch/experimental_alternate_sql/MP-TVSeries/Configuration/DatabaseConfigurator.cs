...
namespace WindowPlugins.GUITVSeries.Configuration
{
    ...
    {
        private const string defaultConnectionString = "Persist Security Info=True;USER ID=sa;Password=mediaportal;Initial Catalog=MpTvSeriesDb4;Data Source=(localhost);Connection Timeout=300";
