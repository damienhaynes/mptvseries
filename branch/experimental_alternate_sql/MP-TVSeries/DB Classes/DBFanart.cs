...
namespace WindowPlugins.GUITVSeries
{
    public class DBFanart : DBTable
    {
        ...
        private void InitColumns()
        {
            ...
            AddColumn(cChosen, new DBField(DBField.cTypeString, 100));
            AddColumn(cLocalPath, new DBField(DBField.cTypeString, 1024));
            AddColumn(cBannerPath, new DBField(DBField.cTypeString, 1024));
            AddColumn(cThumbnailPath, new DBField(DBField.cTypeString, 1024));
            AddColumn(cColors, new DBField(DBField.cTypeString, 100));
            AddColumn(cDisabled, new DBField(DBField.cTypeString, 10));
        }
        ...
        {       
            ...
            {                              
                ...
                for (int index = 0; index < results.Rows.Count; index++)
                {
                    if (results.Rows[index][cLocalPath].ToString().Length > 0)
                        iFanartCount++;
                    else
                    {
