...
namespace WindowPlugins.GUITVSeries.DataClass
{
    public class DBReplacements : DBTable
    {
		...
		public static readonly DBFieldDefList TableFields = new DBFieldDefList {
            ...
            {cEnabled,		new DBFieldDef{FieldName = cEnabled,	TableName = cTableName,	Type = DBFieldType.Int,		PrettyName = "Enabled"}},
            {cTagEnabled,	new DBFieldDef{FieldName = cTagEnabled,	TableName = cTableName,	Type = DBFieldType.Int,		PrettyName = "Used As Tag"}},
            {cBefore,		new DBFieldDef{FieldName = cBefore,		TableName = cTableName,	Type = DBFieldType.Int,		PrettyName = "Run before matching"}},
			{cToReplace,	new DBFieldDef{FieldName = cToReplace,	TableName = cTableName,	Type = DBFieldType.String,	PrettyName = "Replace this.."}},
            {cWith,			new DBFieldDef{FieldName = cWith,		TableName = cTableName,	Type = DBFieldType.String,	PrettyName = "With this"}},
            {cIsRegex,		new DBFieldDef{FieldName = cIsRegex,	TableName = cTableName,	Type = DBFieldType.Int,		PrettyName = "Is Regex"}}
		};
		#endregion
