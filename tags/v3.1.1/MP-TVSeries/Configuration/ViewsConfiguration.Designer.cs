namespace WindowPlugins.GUITVSeries.Configuration {
    partial class ViewsConfiguration {
        /// <summary>
        ...
        private void InitializeComponent() {
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ViewsConfiguration));
			...
			// groupBoxAdvanced
			// 
			this.groupBoxAdvanced.Controls.Add(this.groupBox11);
			this.groupBoxAdvanced.Controls.Add(this.viewStepGroupLbl);
			...
			this.viewStepGroupLbl.Location = new System.Drawing.Point(133, 30);
			this.viewStepGroupLbl.Name = "viewStepGroupLbl";
			this.viewStepGroupLbl.Size = new System.Drawing.Size(51, 13);
			this.viewStepGroupLbl.TabIndex = 1;
			this.viewStepGroupLbl.Text = "&Group By";
			// 
			// viewStepGroupByTextBox
			// 
			this.viewStepGroupByTextBox.Location = new System.Drawing.Point(188, 27);
            ...
            "season",
            "episode"});
			this.viewStepType.Location = new System.Drawing.Point(6, 27);
			...
			this.toolTipHelp.SetToolTip(this.radioSimple, resources.GetString("radioSimple.ToolTip"));
			this.radioSimple.UseVisualStyleBackColor = true;
			this.radioSimple.Click += new System.EventHandler(this.radioSimple_Click);
			// 
			// radioAdvanced
			// 
			...
			this.toolTipHelp.SetToolTip(this.radioAdvanced, "Select Advanced View i fyou want to dynamically filter series in your view using " +
					"the Condition Builder.");
			this.radioAdvanced.UseVisualStyleBackColor = true;
			this.radioAdvanced.Click += new System.EventHandler(this.radioAdvanced_Click);
			// 
			// toolTipHelp
			// 
			...
			this.toolTipHelp.ToolTipTitle = "Views";
			// 
			// ViewsConfiguration
			// 
			...
			this.Name = "ViewsConfiguration";
			this.ShowIcon = false;
			this.ShowInTaskbar = false;
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "Views Configuration";
			this.TopMost = true;
